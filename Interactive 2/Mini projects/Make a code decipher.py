# Create a frame with two buttons to "encode" and "decode"
# an input message. Computer randomly generates a dictionary 
# of letters to decipher from and to. For example, "a" to "e"
# "b" to "h"
